 ...
 * 描述:
 **/
public abstract class MyBaseActivity <V extends ViewDataBinding, VM extends MyBaseViewModel> extends RxAppCompatActivity implements IBaseView {
    protected V binding;
    ...
    private void initViewDataBinding(Bundle savedInstanceState) {
        ...
        if (viewModel == null) {
            ...
            if (type instanceof ParameterizedType) {
                ...
                modelClass = MyBaseViewModel.class;
            }
    ...
    private void initializeTitleView(){
        titleBar = binding.getRoot().findViewById(R.id.titleview);
        if (titleBar!=null){
